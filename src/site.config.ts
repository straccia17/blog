...
const config: SiteConfig = {
  // Replace this with the final custom-domain URL before launch.
  site: 'https://carlo-straccialini-blog.pages.dev',
  title: 'Carlo Straccialini',
  description: 'Notes on frontend architecture, compilers, and web performance.',
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/straccia17',
      external: true,
    },
  ],
